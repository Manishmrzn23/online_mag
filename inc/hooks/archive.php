...
if (!function_exists('online_magazine_main_content')) {

    function online_magazine_blog_content(){
        ?>
        <?php
            ?>
            <!-- sidebar -->
...
add_action('online_magazine_main_template','online_magazine_main_content');
add_action('online_magazine_main_template','online_magazine_main_content_summary');