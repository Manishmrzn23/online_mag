 ...
 */
add_action('online_magazine_front_page_featured_section_template', 'online_magazine_front_page_featured_section');
add_action('online_magazine_front_page_news1_section_template', 'online_magazine_front_page_news1_section');
add_action('online_magazine_front_page_news2_section_template', 'online_magazine_front_page_news2_section');
add_action('online_magazine_front_page_news3_section_template', 'online_magazine_front_page_news3_section');
add_action('online_magazine_front_page_news4_section_template', 'online_magazine_front_page_news4_section');
add_action('online_magazine_front_page_news5_section_template', 'online_magazine_front_page_news5_section');
