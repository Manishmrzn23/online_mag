...
if (!function_exists('online_magazine_home_content')) {

    function online_magazine_home_content(){
...
add_action('online_magazine_home_template','online_magazine_home_content');